...
def new_reduce_2(function: Callable,
                 sequence: Union[List[Union[int, float, str]], Tuple[Union[int, float, str]],
                                 Set[Union[int, float, str]]]) -> Optional[Union[int, float, str, None]]:
    """
...
def add_two(sequence: List[Union[int, float, str]]) -> Union[int, float, str]:
    result = sequence[0]
...
def multi(sequence: List[Union[int, float]]) -> Union[int, float]:
    result = 1
